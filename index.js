...
function checkAnswer() {
    ...
    if(jsonData.length-1 < i){
        document.write("<body style='background-color:#886A08;'>");
        document.write("<div style=#FF0000;font-size:18pt;text-align:center;'>Your correct answers is : "+correctCount+" </div>");
		document.write("<div style=#3ADF00;font-size:18pt;text-align:center;'><a href='file:///C:/Users/Burlak/Desktop/JS/Lab1/index.html' :'>Pass again test</a> </div>");
        document.write("</body>");
